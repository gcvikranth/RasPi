...
while True and count<100000:
   ...
   if abs(distanceFromObstacle-previousDistance)<0.9:
         print "#Seems to be stuck recovering by reversing"
         ...
         SetLeftMotorForward()
         sleep(3)
   elif got_something_right == 0 and got_something_left == 1:
         ...
         SetRightMotorForward()
         SetLeftMotorForward()
   elif got_something_left == 0 and got_something_right == 1:
...
##         SetLeftMotorForward()
   ...
   if p_angle >180:
       p_angle=0
   sleep(2)
   previousDistance = distanceFromObstacle
